  ...
  return (
    <div className="home-wrapper">
      <section className="about-wrapper">
        <div className="title-primary-page">Project KanBan</div>
          ...
          <div className="box-wrapper">
            <div className="info-developer">
              ...
              <div className="skills-developer">
                ...
                <p className="skills-developer-text">- {t('primary_title.illia_text3')}</p>
                <p className="skills-developer-text">- {t('primary_title.illia_text4')}</p>
                <p className="skills-developer-text">- {t('primary_title.illia_text5')}</p>
          ...
          <div className="box-wrapper">
            <div className="info-developer">
              ...
              <div className="skills-developer">
                ...
                <p className="skills-developer-text">- {t('primary_title.tatsiana_text5')}</p>
              </div>
            </div>
